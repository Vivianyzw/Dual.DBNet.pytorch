...
def init_args():
    ...
    parser.add_argument('--config_file', default='../config/dual_resnet18_FPN_DBhead_polyLR.yaml', type=str)
...
def main(config):
    ...
    trainer = DualTrainer(config=config,
                      model=model,
                      criterion=criterion,
...
if __name__ == '__main__':
    ...
    project = 'DBNet.pytorch.train'  # 工作项目根目录
