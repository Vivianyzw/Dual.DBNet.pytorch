...
class DualIaaAugment():
    ...
    def may_augment_annotation(self, aug, data, shape):
        ...
        line_polys = []
        for poly in data['fore_text_polys']:
            new_poly = self.may_augment_poly(aug, shape, poly)
            line_polys.append(new_poly)
        data['fore_text_polys'] = np.array(line_polys)

        line_polys = []
        for poly in data['back_text_polys']:
            new_poly = self.may_augment_poly(aug, shape, poly)
            line_polys.append(new_poly)
        data['back_text_polys'] = np.array(line_polys)
