...
class DualMakeShrinkMap():
    ...
    def __call__(self, data: dict) -> dict:
        ...
        """
        image = data['img']
        text_polys = data['fore_text_polys']
        ignore_tags = data['fore_ignore_tags']
        ...
        data['fore_shrink_map'] = gt
        data['fore_shrink_mask'] = mask


        text_polys = data['back_text_polys']
        ignore_tags = data['back_ignore_tags']
        ...
        data['back_shrink_map'] = gt
        data['back_shrink_mask'] = mask
        return data
